...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Mechanical Engineer");
        ...
        jButton2.setText("Software Engineer");
        ...
        jButton3.setText("Civil Engineer");
        ...
        jButton4.setText("Electrical Engineer");
        ...
        jButton5.setText("Aerospace Engineer");
        ...
        jButton6.setText("Computer Engineer");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        new PostedJobs(email, "Mechanical Engineer").setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        new PostedJobs(email, "Software Engineer").setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        this.dispose();
        new PostedJobs(email, "Aeronautical Engineer").setVisible(true);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        this.dispose();
        new PostedJobs(email, "Electrical Engineer").setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.dispose();
        new PostedJobs(email, "Civil Engineer").setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        this.dispose();
        new PostedJobs(email, "Computer Engineer").setVisible(true);
